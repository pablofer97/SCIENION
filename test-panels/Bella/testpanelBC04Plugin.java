...
public class testpanelBC03Plugin implements MMPlugin, ActionListener {
	...
	public String moveStage(double startXmm, double startYmm,
		...
		try {
			...
			// TODO Auto-generated catch blocks for all!
			e2.printStackTrace();
		}
		...
		// TODO: reset this
		// double corners[] = fourCorners(startXmm, startYmm, fieldSizemmX,
		// fieldSizemmY);
		...
		for (int i = 0; i < xPos.size(); i++) {
			...
			str4 = "chip" + chipNumber + "_X_" + myXcoord + "_Y_" + myYcoord;
	...
	public ImagePlus fourColor(String mirrorFile, String rootDirName,
			int width, int height, double exposureTime, int numRepeats,
			int numFrames) {
